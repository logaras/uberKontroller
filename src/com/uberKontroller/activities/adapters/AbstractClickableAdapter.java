 ...
 * @author poss3x
 */
public abstract class AbstractClickableAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private LinkedList<Object> mDataObjects; // our generic object list
    private int mViewId;
     ...
     *                list
     */
    public AbstractClickableAdapter(Context context, int viewid, LinkedList objects) {
        ...
        if (objects == null) {
            mDataObjects = new LinkedList<Object>();
        }
    }
     ...
     *
     * @param v The view for the new holder object
     */
